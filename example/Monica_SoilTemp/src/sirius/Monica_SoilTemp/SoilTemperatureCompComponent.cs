...
{
    public class SoilTemperatureCompComponent : IStrategySiriusQualitySoilTemperatureComp
    {
        public SoilTemperatureCompComponent()
        {
            ...
            pd5.DomainClassType = typeof(SiriusQualitySoilTemperatureComp.DomainClass.SoilTemperatureCompExogenous);
            pd5.PropertyName = "soilSurfaceTemperatureBelowSnow";
            pd5.PropertyType = (SiriusQualitySoilTemperatureComp.DomainClass.SoilTemperatureCompExogenousVarInfo.soilSurfaceTemperatureBelowSnow).ValueType.TypeForCurrentValue;
            pd5.PropertyVarInfo =(SiriusQualitySoilTemperatureComp.DomainClass.SoilTemperatureCompExogenousVarInfo.soilSurfaceTemperatureBelowSnow);
            _inputs0_0.Add(pd5);
            PropertyDescription pd6 = new PropertyDescription();
            pd6.DomainClassType = typeof(SiriusQualitySoilTemperatureComp.DomainClass.SoilTemperatureCompExogenous);
            pd6.PropertyName = "hasSnowCover";
            pd6.PropertyType = (SiriusQualitySoilTemperatureComp.DomainClass.SoilTemperatureCompExogenousVarInfo.hasSnowCover).ValueType.TypeForCurrentValue;
            pd6.PropertyVarInfo =(SiriusQualitySoilTemperatureComp.DomainClass.SoilTemperatureCompExogenousVarInfo.hasSnowCover);
            _inputs0_0.Add(pd6);
            PropertyDescription pd7 = new PropertyDescription();
            pd7.DomainClassType = typeof(SiriusQualitySoilTemperatureComp.DomainClass.SoilTemperatureCompState);
            pd7.PropertyName = "V";
            pd7.PropertyType = (SiriusQualitySoilTemperatureComp.DomainClass.SoilTemperatureCompStateVarInfo.V).ValueType.TypeForCurrentValue;
            pd7.PropertyVarInfo =(SiriusQualitySoilTemperatureComp.DomainClass.SoilTemperatureCompStateVarInfo.V);
            _inputs0_0.Add(pd7);
            PropertyDescription pd8 = new PropertyDescription();
            pd8.DomainClassType = typeof(SiriusQualitySoilTemperatureComp.DomainClass.SoilTemperatureCompState);
            pd8.PropertyName = "B";
            pd8.PropertyType = (SiriusQualitySoilTemperatureComp.DomainClass.SoilTemperatureCompStateVarInfo.B).ValueType.TypeForCurrentValue;
            pd8.PropertyVarInfo =(SiriusQualitySoilTemperatureComp.DomainClass.SoilTemperatureCompStateVarInfo.B);
            _inputs0_0.Add(pd8);
            ...
            pd9.PropertyType = (SiriusQualitySoilTemperatureComp.DomainClass.SoilTemperatureCompStateVarInfo.volumeMatrix).ValueType.TypeForCurrentValue;
            pd9.PropertyVarInfo =(SiriusQualitySoilTemperatureComp.DomainClass.SoilTemperatureCompStateVarInfo.volumeMatrix);
            _inputs0_0.Add(pd9);
            ...
            pd10.PropertyType = (SiriusQualitySoilTemperatureComp.DomainClass.SoilTemperatureCompStateVarInfo.volumeMatrixOld).ValueType.TypeForCurrentValue;
            pd10.PropertyVarInfo =(SiriusQualitySoilTemperatureComp.DomainClass.SoilTemperatureCompStateVarInfo.volumeMatrixOld);
            _inputs0_0.Add(pd10);
            ...
            pd11.PropertyType = (SiriusQualitySoilTemperatureComp.DomainClass.SoilTemperatureCompStateVarInfo.matrixPrimaryDiagonal).ValueType.TypeForCurrentValue;
            pd11.PropertyVarInfo =(SiriusQualitySoilTemperatureComp.DomainClass.SoilTemperatureCompStateVarInfo.matrixPrimaryDiagonal);
            _inputs0_0.Add(pd11);
            ...
            pd12.PropertyType = (SiriusQualitySoilTemperatureComp.DomainClass.SoilTemperatureCompStateVarInfo.matrixSecondaryDiagonal).ValueType.TypeForCurrentValue;
            pd12.PropertyVarInfo =(SiriusQualitySoilTemperatureComp.DomainClass.SoilTemperatureCompStateVarInfo.matrixSecondaryDiagonal);
            _inputs0_0.Add(pd12);
            ...
            pd13.PropertyType = (SiriusQualitySoilTemperatureComp.DomainClass.SoilTemperatureCompStateVarInfo.heatConductivity).ValueType.TypeForCurrentValue;
            pd13.PropertyVarInfo =(SiriusQualitySoilTemperatureComp.DomainClass.SoilTemperatureCompStateVarInfo.heatConductivity);
            _inputs0_0.Add(pd13);
            ...
            pd14.PropertyType = (SiriusQualitySoilTemperatureComp.DomainClass.SoilTemperatureCompStateVarInfo.heatConductivityMean).ValueType.TypeForCurrentValue;
            pd14.PropertyVarInfo =(SiriusQualitySoilTemperatureComp.DomainClass.SoilTemperatureCompStateVarInfo.heatConductivityMean);
            _inputs0_0.Add(pd14);
            ...
            pd15.PropertyType = (SiriusQualitySoilTemperatureComp.DomainClass.SoilTemperatureCompStateVarInfo.heatCapacity).ValueType.TypeForCurrentValue;
            pd15.PropertyVarInfo =(SiriusQualitySoilTemperatureComp.DomainClass.SoilTemperatureCompStateVarInfo.heatCapacity);
            _inputs0_0.Add(pd15);
            ...
            pd16.PropertyType = (SiriusQualitySoilTemperatureComp.DomainClass.SoilTemperatureCompStateVarInfo.solution).ValueType.TypeForCurrentValue;
            pd16.PropertyVarInfo =(SiriusQualitySoilTemperatureComp.DomainClass.SoilTemperatureCompStateVarInfo.solution);
            _inputs0_0.Add(pd16);
            PropertyDescription pd17 = new PropertyDescription();
            pd17.DomainClassType = typeof(SiriusQualitySoilTemperatureComp.DomainClass.SoilTemperatureCompState);
            pd17.PropertyName = "matrixDiagonal";
            pd17.PropertyType = (SiriusQualitySoilTemperatureComp.DomainClass.SoilTemperatureCompStateVarInfo.matrixDiagonal).ValueType.TypeForCurrentValue;
            pd17.PropertyVarInfo =(SiriusQualitySoilTemperatureComp.DomainClass.SoilTemperatureCompStateVarInfo.matrixDiagonal);
            _inputs0_0.Add(pd17);
            PropertyDescription pd18 = new PropertyDescription();
            pd18.DomainClassType = typeof(SiriusQualitySoilTemperatureComp.DomainClass.SoilTemperatureCompState);
            pd18.PropertyName = "matrixLowerTriangle";
            pd18.PropertyType = (SiriusQualitySoilTemperatureComp.DomainClass.SoilTemperatureCompStateVarInfo.matrixLowerTriangle).ValueType.TypeForCurrentValue;
            pd18.PropertyVarInfo =(SiriusQualitySoilTemperatureComp.DomainClass.SoilTemperatureCompStateVarInfo.matrixLowerTriangle);
            _inputs0_0.Add(pd18);
            PropertyDescription pd19 = new PropertyDescription();
            pd19.DomainClassType = typeof(SiriusQualitySoilTemperatureComp.DomainClass.SoilTemperatureCompState);
            pd19.PropertyName = "heatFlow";
            pd19.PropertyType = (SiriusQualitySoilTemperatureComp.DomainClass.SoilTemperatureCompStateVarInfo.heatFlow).ValueType.TypeForCurrentValue;
            pd19.PropertyVarInfo =(SiriusQualitySoilTemperatureComp.DomainClass.SoilTemperatureCompStateVarInfo.heatFlow);
            _inputs0_0.Add(pd19);
            mo0_0.Inputs=_inputs0_0;
            List<PropertyDescription> _outputs0_0 = new List<PropertyDescription>();
            PropertyDescription pd20 = new PropertyDescription();
            pd20.DomainClassType = typeof(SiriusQualitySoilTemperatureComp.DomainClass.SoilTemperatureCompState);
            pd20.PropertyName = "soilSurfaceTemperature";
            pd20.PropertyType = (SiriusQualitySoilTemperatureComp.DomainClass.SoilTemperatureCompStateVarInfo.soilSurfaceTemperature).ValueType.TypeForCurrentValue;
            pd20.PropertyVarInfo =(SiriusQualitySoilTemperatureComp.DomainClass.SoilTemperatureCompStateVarInfo.soilSurfaceTemperature);
            _outputs0_0.Add(pd20);
            PropertyDescription pd21 = new PropertyDescription();
            pd21.DomainClassType = typeof(SiriusQualitySoilTemperatureComp.DomainClass.SoilTemperatureCompState);
            pd21.PropertyName = "soilTemperature";
            pd21.PropertyType = (SiriusQualitySoilTemperatureComp.DomainClass.SoilTemperatureCompStateVarInfo.soilTemperature).ValueType.TypeForCurrentValue;
            pd21.PropertyVarInfo =(SiriusQualitySoilTemperatureComp.DomainClass.SoilTemperatureCompStateVarInfo.soilTemperature);
            _outputs0_0.Add(pd21);
            mo0_0.Outputs=_outputs0_0;
            List<string> lAssStrat0_0 = new List<string>();
            lAssStrat0_0.Add(typeof(SiriusQualitySoilTemperatureComp.Strategies.SoilTemperature).FullName);
            lAssStrat0_0.Add(typeof(SiriusQualitySoilTemperatureComp.Strategies.NoSnowSoilSurfaceTemperature).FullName);
            lAssStrat0_0.Add(typeof(SiriusQualitySoilTemperatureComp.Strategies.WithSnowSoilSurfaceTemperature).FullName);
        ...
        {
            get { return SiriusQualitySoilTemperatureComp.Strategies.NoSnowSoilSurfaceTemperature.dampingFactorVarInfo;} 
        }

        public static VarInfo timeStepVarInfo
        {
            get { return SiriusQualitySoilTemperatureComp.Strategies.SoilTemperature.timeStepVarInfo;} 
        }

        public static VarInfo soilMoistureConstVarInfo
        {
            get { return SiriusQualitySoilTemperatureComp.Strategies.SoilTemperature.soilMoistureConstVarInfo;} 
        }

        public static VarInfo baseTempVarInfo
        {
            get { return SiriusQualitySoilTemperatureComp.Strategies.SoilTemperature.baseTempVarInfo;} 
        }

        public static VarInfo initialSurfaceTempVarInfo
        {
            get { return SiriusQualitySoilTemperatureComp.Strategies.SoilTemperature.initialSurfaceTempVarInfo;} 
        }

        public static VarInfo densityAirVarInfo
        {
            get { return SiriusQualitySoilTemperatureComp.Strategies.SoilTemperature.densityAirVarInfo;} 
        }

        public static VarInfo specificHeatCapacityAirVarInfo
        {
            get { return SiriusQualitySoilTemperatureComp.Strategies.SoilTemperature.specificHeatCapacityAirVarInfo;} 
        }

        public static VarInfo densityHumusVarInfo
        {
            get { return SiriusQualitySoilTemperatureComp.Strategies.SoilTemperature.densityHumusVarInfo;} 
        }

        public static VarInfo specificHeatCapacityHumusVarInfo
        {
            get { return SiriusQualitySoilTemperatureComp.Strategies.SoilTemperature.specificHeatCapacityHumusVarInfo;} 
        }

        public static VarInfo densityWaterVarInfo
        {
            get { return SiriusQualitySoilTemperatureComp.Strategies.SoilTemperature.densityWaterVarInfo;} 
        }

        public static VarInfo specificHeatCapacityWaterVarInfo
        {
            get { return SiriusQualitySoilTemperatureComp.Strategies.SoilTemperature.specificHeatCapacityWaterVarInfo;} 
        }

        public static VarInfo quartzRawDensityVarInfo
        {
            get { return SiriusQualitySoilTemperatureComp.Strategies.SoilTemperature.quartzRawDensityVarInfo;} 
        }

        public static VarInfo specificHeatCapacityQuartzVarInfo
        {
            get { return SiriusQualitySoilTemperatureComp.Strategies.SoilTemperature.specificHeatCapacityQuartzVarInfo;} 
        }

        public static VarInfo nTauVarInfo
        {
            get { return SiriusQualitySoilTemperatureComp.Strategies.SoilTemperature.nTauVarInfo;} 
        }

        public static VarInfo noOfTempLayersVarInfo
        {
            get { return SiriusQualitySoilTemperatureComp.Strategies.SoilTemperature.noOfTempLayersVarInfo;} 
        }

        public static VarInfo noOfTempLayersPlus1VarInfo
        {
            get { return SiriusQualitySoilTemperatureComp.Strategies.SoilTemperature.noOfTempLayersPlus1VarInfo;} 
        }

        public static VarInfo noOfSoilLayersVarInfo
        {
            get { return SiriusQualitySoilTemperatureComp.Strategies.SoilTemperature.noOfSoilLayersVarInfo;} 
        }

        public static VarInfo layerThicknessVarInfo
        {
            get { return SiriusQualitySoilTemperatureComp.Strategies.SoilTemperature.layerThicknessVarInfo;} 
        }

        public static VarInfo soilBulkDensityVarInfo
        {
            get { return SiriusQualitySoilTemperatureComp.Strategies.SoilTemperature.soilBulkDensityVarInfo;} 
        }

        public static VarInfo saturationVarInfo
        {
            get { return SiriusQualitySoilTemperatureComp.Strategies.SoilTemperature.saturationVarInfo;} 
        }

        public static VarInfo soilOrganicMatterVarInfo
        {
            get { return SiriusQualitySoilTemperatureComp.Strategies.SoilTemperature.soilOrganicMatterVarInfo;} 
        }
        ...
        public string TestPostConditions(SiriusQualitySoilTemperatureComp.DomainClass.SoilTemperatureCompState s,SiriusQualitySoilTemperatureComp.DomainClass.SoilTemperatureCompState s1,SiriusQualitySoilTemperatureComp.DomainClass.SoilTemperatureCompRate r,SiriusQualitySoilTemperatureComp.DomainClass.SoilTemperatureCompAuxiliary a,SiriusQualitySoilTemperatureComp.DomainClass.SoilTemperatureCompExogenous ex,string callID)
        {
            try
            {
                ...
                RangeBasedCondition r41 = new RangeBasedCondition(SiriusQualitySoilTemperatureComp.DomainClass.SoilTemperatureCompStateVarInfo.soilSurfaceTemperature);
                if(r41.ApplicableVarInfoValueTypes.Contains( SiriusQualitySoilTemperatureComp.DomainClass.SoilTemperatureCompStateVarInfo.soilSurfaceTemperature.ValueType)){prc.AddCondition(r41);}
                RangeBasedCondition r42 = new RangeBasedCondition(SiriusQualitySoilTemperatureComp.DomainClass.SoilTemperatureCompStateVarInfo.soilTemperature);
                if(r42.ApplicableVarInfoValueTypes.Contains( SiriusQualitySoilTemperatureComp.DomainClass.SoilTemperatureCompStateVarInfo.soilTemperature.ValueType)){prc.AddCondition(r42);}

                string ret = "";
                ret += _SoilTemperature.TestPostConditions(s, s1, r, a, ex, " strategy SiriusQualitySoilTemperatureComp.Strategies.SoilTemperatureComp");
                ret += _NoSnowSoilSurfaceTemperature.TestPostConditions(s, s1, r, a, ex, " strategy SiriusQualitySoilTemperatureComp.Strategies.SoilTemperatureComp");
                ret += _WithSnowSoilSurfaceTemperature.TestPostConditions(s, s1, r, a, ex, " strategy SiriusQualitySoilTemperatureComp.Strategies.SoilTemperatureComp");
            ...
            {
                string msg = "Component SiriusQuality.SoilTemperatureComp, " + this.GetType().Name + ": Unhandled exception running post-condition test. ";
        ...
        public string TestPreConditions(SiriusQualitySoilTemperatureComp.DomainClass.SoilTemperatureCompState s,SiriusQualitySoilTemperatureComp.DomainClass.SoilTemperatureCompState s1,SiriusQualitySoilTemperatureComp.DomainClass.SoilTemperatureCompRate r,SiriusQualitySoilTemperatureComp.DomainClass.SoilTemperatureCompAuxiliary a,SiriusQualitySoilTemperatureComp.DomainClass.SoilTemperatureCompExogenous ex,string callID)
        {
            try
            {
                ...
                RangeBasedCondition r5 = new RangeBasedCondition(SiriusQualitySoilTemperatureComp.DomainClass.SoilTemperatureCompExogenousVarInfo.soilSurfaceTemperatureBelowSnow);
                if(r5.ApplicableVarInfoValueTypes.Contains( SiriusQualitySoilTemperatureComp.DomainClass.SoilTemperatureCompExogenousVarInfo.soilSurfaceTemperatureBelowSnow.ValueType)){prc.AddCondition(r5);}
                RangeBasedCondition r6 = new RangeBasedCondition(SiriusQualitySoilTemperatureComp.DomainClass.SoilTemperatureCompExogenousVarInfo.hasSnowCover);
                if(r6.ApplicableVarInfoValueTypes.Contains( SiriusQualitySoilTemperatureComp.DomainClass.SoilTemperatureCompExogenousVarInfo.hasSnowCover.ValueType)){prc.AddCondition(r6);}
                RangeBasedCondition r7 = new RangeBasedCondition(SiriusQualitySoilTemperatureComp.DomainClass.SoilTemperatureCompStateVarInfo.V);
                if(r7.ApplicableVarInfoValueTypes.Contains( SiriusQualitySoilTemperatureComp.DomainClass.SoilTemperatureCompStateVarInfo.V.ValueType)){prc.AddCondition(r7);}
                RangeBasedCondition r8 = new RangeBasedCondition(SiriusQualitySoilTemperatureComp.DomainClass.SoilTemperatureCompStateVarInfo.B);
                if(r8.ApplicableVarInfoValueTypes.Contains( SiriusQualitySoilTemperatureComp.DomainClass.SoilTemperatureCompStateVarInfo.B.ValueType)){prc.AddCondition(r8);}
                RangeBasedCondition r9 = new RangeBasedCondition(SiriusQualitySoilTemperatureComp.DomainClass.SoilTemperatureCompStateVarInfo.volumeMatrix);
                if(r9.ApplicableVarInfoValueTypes.Contains( SiriusQualitySoilTemperatureComp.DomainClass.SoilTemperatureCompStateVarInfo.volumeMatrix.ValueType)){prc.AddCondition(r9);}
                RangeBasedCondition r10 = new RangeBasedCondition(SiriusQualitySoilTemperatureComp.DomainClass.SoilTemperatureCompStateVarInfo.volumeMatrixOld);
                if(r10.ApplicableVarInfoValueTypes.Contains( SiriusQualitySoilTemperatureComp.DomainClass.SoilTemperatureCompStateVarInfo.volumeMatrixOld.ValueType)){prc.AddCondition(r10);}
                RangeBasedCondition r11 = new RangeBasedCondition(SiriusQualitySoilTemperatureComp.DomainClass.SoilTemperatureCompStateVarInfo.matrixPrimaryDiagonal);
                if(r11.ApplicableVarInfoValueTypes.Contains( SiriusQualitySoilTemperatureComp.DomainClass.SoilTemperatureCompStateVarInfo.matrixPrimaryDiagonal.ValueType)){prc.AddCondition(r11);}
                RangeBasedCondition r12 = new RangeBasedCondition(SiriusQualitySoilTemperatureComp.DomainClass.SoilTemperatureCompStateVarInfo.matrixSecondaryDiagonal);
                if(r12.ApplicableVarInfoValueTypes.Contains( SiriusQualitySoilTemperatureComp.DomainClass.SoilTemperatureCompStateVarInfo.matrixSecondaryDiagonal.ValueType)){prc.AddCondition(r12);}
                RangeBasedCondition r13 = new RangeBasedCondition(SiriusQualitySoilTemperatureComp.DomainClass.SoilTemperatureCompStateVarInfo.heatConductivity);
                if(r13.ApplicableVarInfoValueTypes.Contains( SiriusQualitySoilTemperatureComp.DomainClass.SoilTemperatureCompStateVarInfo.heatConductivity.ValueType)){prc.AddCondition(r13);}
                RangeBasedCondition r14 = new RangeBasedCondition(SiriusQualitySoilTemperatureComp.DomainClass.SoilTemperatureCompStateVarInfo.heatConductivityMean);
                if(r14.ApplicableVarInfoValueTypes.Contains( SiriusQualitySoilTemperatureComp.DomainClass.SoilTemperatureCompStateVarInfo.heatConductivityMean.ValueType)){prc.AddCondition(r14);}
                RangeBasedCondition r15 = new RangeBasedCondition(SiriusQualitySoilTemperatureComp.DomainClass.SoilTemperatureCompStateVarInfo.heatCapacity);
                if(r15.ApplicableVarInfoValueTypes.Contains( SiriusQualitySoilTemperatureComp.DomainClass.SoilTemperatureCompStateVarInfo.heatCapacity.ValueType)){prc.AddCondition(r15);}
                RangeBasedCondition r16 = new RangeBasedCondition(SiriusQualitySoilTemperatureComp.DomainClass.SoilTemperatureCompStateVarInfo.solution);
                if(r16.ApplicableVarInfoValueTypes.Contains( SiriusQualitySoilTemperatureComp.DomainClass.SoilTemperatureCompStateVarInfo.solution.ValueType)){prc.AddCondition(r16);}
                RangeBasedCondition r17 = new RangeBasedCondition(SiriusQualitySoilTemperatureComp.DomainClass.SoilTemperatureCompStateVarInfo.matrixDiagonal);
                if(r17.ApplicableVarInfoValueTypes.Contains( SiriusQualitySoilTemperatureComp.DomainClass.SoilTemperatureCompStateVarInfo.matrixDiagonal.ValueType)){prc.AddCondition(r17);}
                RangeBasedCondition r18 = new RangeBasedCondition(SiriusQualitySoilTemperatureComp.DomainClass.SoilTemperatureCompStateVarInfo.matrixLowerTriangle);
                if(r18.ApplicableVarInfoValueTypes.Contains( SiriusQualitySoilTemperatureComp.DomainClass.SoilTemperatureCompStateVarInfo.matrixLowerTriangle.ValueType)){prc.AddCondition(r18);}
                RangeBasedCondition r19 = new RangeBasedCondition(SiriusQualitySoilTemperatureComp.DomainClass.SoilTemperatureCompStateVarInfo.heatFlow);
                if(r19.ApplicableVarInfoValueTypes.Contains( SiriusQualitySoilTemperatureComp.DomainClass.SoilTemperatureCompStateVarInfo.heatFlow.ValueType)){prc.AddCondition(r19);}
                ...
                string ret = "";
                ret += _SoilTemperature.TestPreConditions(s, s1, r, a, ex, " strategy SiriusQualitySoilTemperatureComp.Strategies.SoilTemperatureComp");
                ret += _NoSnowSoilSurfaceTemperature.TestPreConditions(s, s1, r, a, ex, " strategy SiriusQualitySoilTemperatureComp.Strategies.SoilTemperatureComp");
                ret += _WithSnowSoilSurfaceTemperature.TestPreConditions(s, s1, r, a, ex, " strategy SiriusQualitySoilTemperatureComp.Strategies.SoilTemperatureComp");
            ...
            {
                string msg = "Component SiriusQuality.SoilTemperatureComp, " + this.GetType().Name + ": Unhandled exception running pre-condition test. ";
                throw new Exception(msg, exception);
            }
        }
        ...
        private void EstimateOfAssociatedClasses(SiriusQualitySoilTemperatureComp.DomainClass.SoilTemperatureCompState s,SiriusQualitySoilTemperatureComp.DomainClass.SoilTemperatureCompState s1,SiriusQualitySoilTemperatureComp.DomainClass.SoilTemperatureCompRate r,SiriusQualitySoilTemperatureComp.DomainClass.SoilTemperatureCompAuxiliary a,SiriusQualitySoilTemperatureComp.DomainClass.SoilTemperatureCompExogenous ex)
        {
