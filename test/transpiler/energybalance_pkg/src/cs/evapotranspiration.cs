...
public class Evapotranspiration_
{
    public static double evapotranspiration_(int isWindVpDefined,double evapoTranspirationPriestlyTaylor,double evapoTranspirationPenman)
    {
        //- Description:
