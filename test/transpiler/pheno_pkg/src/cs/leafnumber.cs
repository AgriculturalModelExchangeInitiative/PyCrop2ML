...
{
    public static Tuple<double,double>  leafnumber_(double deltaTT,double phyllochron,int hasFlagLeafLiguleAppeared,int switchMaize,double atip,double leaf_tip_emerg,double k_bl,double nlim,double leafNumber,double cumulTTPhenoMaizeAtEmergence,double cumulTT,double phase)
    {
        //- Description:
    ...
    //                          - uri : some url
        ...
        return Tuple.Create(leafNumber, ntip);
    }
}