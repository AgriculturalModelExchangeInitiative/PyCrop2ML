MODULE Leafnumber_mod
    ...
    IMPLICIT NONE
    CONTAINS
        SUBROUTINE leafnumber_(deltaTT,phyllochron,hasFlagLeafLiguleAppeared,switchMaize,atip,leaf_tip_emerg,k_bl,nlim,leafNumber,cumulTTPhenoMaizeAtEmergence,cumulTT,phase,ntip)
