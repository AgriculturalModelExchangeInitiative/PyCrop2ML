MODULE Shootnumber_mod
    ...
    IMPLICIT NONE
    CONTAINS
        SUBROUTINE shootnumber_(canopyShootNumber,leafNumber,sowingDensity,targetFertileShoot,tilleringProfile,leafTillerNumberArray,tillerNumber,averageShootNumberPerPlant)
            ...
            INTEGER, ALLOCATABLE , DIMENSION(:), INTENT(INOUT) :: leafTillerNumberArray
    ...
    !                          - unit : 
            ...
            canopyShootNumber = MIN(REAL(shoots * sowingDensity), targetFertileShoot)
            ...
            DO i = SIZE(leafTillerNumberArray) + (1) , INT(REAL(CEILING(leafNumber))) , 1
