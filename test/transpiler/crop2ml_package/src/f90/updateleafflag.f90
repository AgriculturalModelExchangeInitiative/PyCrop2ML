MODULE Updateleafflag_mod
    ...
    IMPLICIT NONE
    CONTAINS
        SUBROUTINE updateleafflag_(cumulTT,leafNumber,calendarMoments,calendarDates,calendarCumuls,currentdate,finalLeafNumber,hasFlagLeafLiguleAppeared,phase)
