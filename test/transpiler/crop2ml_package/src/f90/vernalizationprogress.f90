MODULE Vernalizationprogress_mod
    ...
    IMPLICIT NONE
    CONTAINS
        SUBROUTINE vernalizationprogress_(dayLength,deltaTT,cumulTT,leafNumber,calendarMoments,calendarDates,calendarCumuls,minTvern,intTvern,vAI,vBEE,minDL,maxDL,maxTvern,pNini,aMXLFNO,vernaprog,currentdate,isVernalizable,minFinalNumber)
            REAL:: maxVernaProg
            REAL:: dLverna
            REAL:: primordno
            REAL:: minLeafNumber
