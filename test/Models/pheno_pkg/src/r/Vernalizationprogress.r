model_vernalizationprogress <- function (dayLength = 12.3037621834005,
    ...
    if (isVernalizable == 1 && vernaprog_t1 < 1.0)
    {
        ...
        if (vernaprog >= 1.0 || primordno >= aMXLFNO)
        {
            ...
            calendarMoments <- c(calendarMoments, 'EndVernalisation')
    ...
    return (list ("vernaprog" = vernaprog,"minFinalNumber" = minFinalNumber,"calendarMoments" = calendarMoments,"calendarDates" = calendarDates,"calendarCumuls" = calendarCumuls))
}