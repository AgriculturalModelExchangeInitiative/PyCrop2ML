...
void Cropheatflux::Calculate_Model(EnergybalanceState& s, EnergybalanceState& s1, EnergybalanceRate& r, EnergybalanceAuxiliary& a)
{
    ...
    //                          ** unit : g m-2 d-1
    //                          ** uri : http://www1.clermont.inra.fr/siriusquality/?page_id=547
    float netRadiationEquivalentEvaporation = a.getnetRadiationEquivalentEvaporation();
    float soilHeatFlux = r.getsoilHeatFlux();
    float potentialTranspiration = r.getpotentialTranspiration();
    float cropHeatFlux;
