...
project = u"pycropml"
copyright = u"2017-2023, pycropml"
...
# [howto/manual]).
latex_documents = [
    (u"index", u"pycropml.tex",
     u"pycropml Documentation",
     u"Cyrille Ahmed Midingoyi", u"manual"),
]
...
texinfo_documents = [
    (u"index", u"pycropml",
     ...
     u"pycropml",
     u"A Python library to generate components from Crop2ML declarative language",
     u"Miscellaneous"),
]
