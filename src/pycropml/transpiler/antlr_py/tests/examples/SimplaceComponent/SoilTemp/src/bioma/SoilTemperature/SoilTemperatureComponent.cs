...
namespace SoilTemperature.Strategies
{
    public class SoilTemperatureComponent : IStrategySoilTemperature
    {
        public SoilTemperatureComponent()
        {
            ...
            VarInfo v5 = new CompositeStrategyVarInfo(_STMPsimCalculator, "cAverageBulkDensity");
            _parameters0_0.Add(v5);
            VarInfo v6 = new CompositeStrategyVarInfo(_STMPsimCalculator, "cDampingDepth");
            ...
            pd10.PropertyName = "SoilSurfaceTemperature";
            pd10.PropertyType = (SoilTemperature.DomainClass.SoilTemperatureStateVarInfo.SoilSurfaceTemperature).ValueType.TypeForCurrentValue;
            pd10.PropertyVarInfo =(SoilTemperature.DomainClass.SoilTemperatureStateVarInfo.SoilSurfaceTemperature);
            _outputs0_0.Add(pd10);
            PropertyDescription pd11 = new PropertyDescription();
            pd11.DomainClassType = typeof(SoilTemperature.DomainClass.SoilTemperatureAuxiliary);
            pd11.PropertyName = "SnowIsolationIndex";
            pd11.PropertyType = (SoilTemperature.DomainClass.SoilTemperatureAuxiliaryVarInfo.SnowIsolationIndex).ValueType.TypeForCurrentValue;
            pd11.PropertyVarInfo =(SoilTemperature.DomainClass.SoilTemperatureAuxiliaryVarInfo.SnowIsolationIndex);
            _outputs0_0.Add(pd11);
            PropertyDescription pd12 = new PropertyDescription();
            pd12.DomainClassType = typeof(SoilTemperature.DomainClass.SoilTemperatureState);
            pd12.PropertyName = "SnowWaterContent";
            pd12.PropertyType = (SoilTemperature.DomainClass.SoilTemperatureStateVarInfo.SnowWaterContent).ValueType.TypeForCurrentValue;
            pd12.PropertyVarInfo =(SoilTemperature.DomainClass.SoilTemperatureStateVarInfo.SnowWaterContent);
            _outputs0_0.Add(pd12);
            PropertyDescription pd13 = new PropertyDescription();
            pd13.DomainClassType = typeof(SoilTemperature.DomainClass.SoilTemperatureState);
            pd13.PropertyName = "SoilTempArray";
            pd13.PropertyType = (SoilTemperature.DomainClass.SoilTemperatureStateVarInfo.SoilTempArray).ValueType.TypeForCurrentValue;
            pd13.PropertyVarInfo =(SoilTemperature.DomainClass.SoilTemperatureStateVarInfo.SoilTempArray);
        ...
        private static void SetStaticParametersVarInfoDefinitions()
        {
            ...
            cSoilLayerDepthVarInfo.MaxValue = 20.0;
            cSoilLayerDepthVarInfo.MinValue = 0.03;
            cSoilLayerDepthVarInfo.DefaultValue = ;
            ...
            cFirstDayMeanTempVarInfo.DefaultValue = ;
            ...
            cAverageGroundTemperatureVarInfo.DefaultValue = ;
        ...
        public string TestPostConditions(SoilTemperature.DomainClass.SoilTemperatureState s,SoilTemperature.DomainClass.SoilTemperatureState s1,SoilTemperature.DomainClass.SoilTemperatureRate r,SoilTemperature.DomainClass.SoilTemperatureAuxiliary a,SoilTemperature.DomainClass.SoilTemperatureExogenous ex,string callID)
        {
            try
            {
                ...
                RangeBasedCondition r16 = new RangeBasedCondition(SoilTemperature.DomainClass.SoilTemperatureStateVarInfo.SoilSurfaceTemperature);
                if(r16.ApplicableVarInfoValueTypes.Contains( SoilTemperature.DomainClass.SoilTemperatureStateVarInfo.SoilSurfaceTemperature.ValueType)){prc.AddCondition(r16);}
                ...
                RangeBasedCondition r18 = new RangeBasedCondition(SoilTemperature.DomainClass.SoilTemperatureStateVarInfo.SnowWaterContent);
                if(r18.ApplicableVarInfoValueTypes.Contains( SoilTemperature.DomainClass.SoilTemperatureStateVarInfo.SnowWaterContent.ValueType)){prc.AddCondition(r18);}
                RangeBasedCondition r19 = new RangeBasedCondition(SoilTemperature.DomainClass.SoilTemperatureStateVarInfo.SoilTempArray);
                if(r19.ApplicableVarInfoValueTypes.Contains( SoilTemperature.DomainClass.SoilTemperatureStateVarInfo.SoilTempArray.ValueType)){prc.AddCondition(r19);}
