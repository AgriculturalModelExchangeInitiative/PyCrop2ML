...
public class SnowCoverCalculator extends FWSimComponent
{
	...
	public HashMap<String, FWSimVariable<?>> fillTestVariables(int aParamIndex, TEST_STATE aDefineOrCheck)
	{
		...
		{
			FWSimVariable.setValue(10d, iFieldMap.get("SnowCoverCalculator.cCarbonContent"), this);
			FWSimVariable.setValue(3d, iFieldMap.get("SnowCoverCalculator.iTempMax"), this);
			FWSimVariable.setValue(-9d, iFieldMap.get("SnowCoverCalculator.iTempMin"), this);
			FWSimVariable.setValue(1.4, iFieldMap.get("SnowCoverCalculator.iRadiation"), this);
			FWSimVariable.setValue(6d, iFieldMap.get("SnowCoverCalculator.iRAIN"), this);
			FWSimVariable.setValue(30d, iFieldMap.get("SnowCoverCalculator.iCropResidues"), this);
			...
			FWSimVariable.setValue(5d, iFieldMap.get("SnowCoverCalculator.SnowWaterContent"), this);
