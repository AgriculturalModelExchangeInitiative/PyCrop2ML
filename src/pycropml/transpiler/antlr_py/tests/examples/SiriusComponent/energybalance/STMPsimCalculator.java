...
package pycropml.transpiler.antlr_py.tests.examples.SiriusComponent.energybalance;
/*@
 ...
 * More information on <http://www.simplace.net>
  ...
  *
  * where
  * STMP is the soil temperature at the center of a soil layer in ï¿½C,
  ...
  *
  * where
  * DST0 is the final estimate of soil surface temperature in ï¿½C and
 ...
 public class STMPsimCalculator extends FWSimComponent
 {
     ...
     {
         addVariable(FWSimVariable.createSimVariable("iSoilWaterContent", "Content of water in Soil", 
                    DATA_TYPE.DOUBLE, CONTENT_TYPE.input, "mm", 1.5, 20d, 5d, this));
         addVariable(FWSimVariable.createSimVariable("SoilTempArray", "Array of temperature ", 
                    DATA_TYPE.DOUBLEARRAY, CONTENT_TYPE.out, "degC", -20, 40, null, this));
        //...
          return iFieldMap;
     }
     ...
     public HashMap<String, FWSimVariable<?>> fillTestVariables(int aParamIndex)
     {
		if(aParamIndex == 0) //before process
		{
		...
		if(aParamIndex == 1) //after process
		{
