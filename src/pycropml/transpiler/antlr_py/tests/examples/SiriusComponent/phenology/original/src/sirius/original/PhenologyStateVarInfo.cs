...
namespace SiriusQualityPhenology.DomainClass
{
    public class PhenologyStateVarInfo : IVarInfoClass
    {
        ...
        static void DescribeVariables()
        {
            ...
            _listTTShootWindowForPTQ1.Units = "Â°C d";
            ...
            _listTTShootWindowForPTQ.Units = "Â°C d";
            ...
            _phyllochron.Units = "Â°C d leaf-1";
            ...
            _ptq.MinValue = 0.0;
            _ptq.DefaultValue = -1D;
            _ptq.Units = "MJ Â°C-1 d-1 m-2)";
            ...
            _hasZadokStageChanged.DefaultValue = -1D;
