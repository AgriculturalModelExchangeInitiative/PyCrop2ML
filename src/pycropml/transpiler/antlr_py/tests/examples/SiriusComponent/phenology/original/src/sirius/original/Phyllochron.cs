...
namespace SiriusQualityPhenology.Strategies
{
    public class Phyllochron : IStrategySiriusQualityPhenology
    {
        public Phyllochron()
        {
            ...
            v1.DefaultValue = 0.0;
            v1.Description = "Leaf Number efficace";
            v1.Id = 0;
            v1.MaxValue = 1000.0;
            v1.MinValue = 0.0;
            v1.Name = "lNeff";
            ...
            v3.DefaultValue = 8.0;
            v3.Description = "Leaf number above which the phyllochron is increased by Pincr";
            v3.Id = 0;
            v3.MaxValue = 30.0;
            v3.MinValue = 0.0;
            v3.Name = "lincr";
            ...
            v4.DefaultValue = 20.0;
            v4.Description = "Phyllochron at PTQ equal 1";
            v4.Id = 0;
            v4.MaxValue = 1000.0;
            v4.MinValue = 0.0;
            v4.Name = "B";
            v4.Size = 1;
            v4.Units = "Â°C d leaf-1";
            v4.URL = "";
            ...
            v5.DefaultValue = 0.4;
            v5.Description = "Factor decreasing the phyllochron for leaf number less than Ldecr";
            v5.Id = 0;
            v5.MaxValue = 10.0;
            v5.MinValue = 0.0;
            v5.Name = "pdecr";
            ...
            v7.DefaultValue = 0.0;
            v7.Description = "Sowing Density";
            v7.Id = 0;
            v7.MaxValue = 1000.0;
            v7.MinValue = 0.0;
            v7.Name = "sowingDensity";
            v7.Size = 1;
            v7.Units = "plant m-2";
            v7.URL = "";
            ...
            v9.DefaultValue = 120.0;
            v9.Description = "Phyllochron (Varietal parameter)";
            v9.Id = 0;
            v9.MaxValue = 1000.0;
            v9.MinValue = 0.0;
            v9.Name = "p";
            v9.Size = 1;
            v9.Units = "Â°C d leaf-1";
            v9.URL = "";
            ...
            v10.DefaultValue = -1D;
            v10.Description = "Switch to choose the type of phyllochron calculation to be used";
            v10.Id = 0;
            v10.MaxValue = -1D;
            v10.MinValue = -1D;
            v10.Name = "choosePhyllUse";
            v10.Size = 1;
            v10.Units = "-";
            v10.URL = "";
            v10.VarType = CRA.ModelLayer.Core.VarInfo.Type.PARAMETER;
            v10.ValueType = VarInfoValueTypes.GetInstanceForName("String");
            _parameters0_0.Add(v10);
            VarInfo v11 = new VarInfo();
            v11.DefaultValue = 0.0;
            v11.Description = " Area Leaf";
            v11.Id = 0;
            v11.MaxValue = 1000.0;
            v11.MinValue = 0.0;
            v11.Name = "areaSL";
            ...
            v12.Description = "Leaf number up to which the phyllochron is decreased by Pdecr";
            v12.Id = 0;
            v12.MaxValue = 100.0;
            v12.MinValue = 0.0;
            v12.Name = "ldecr";
            ...
            v13.Description = "Slope to intercept ratio for Phyllochron  parametrization with PhotoThermal Quotient";
            v13.Id = 0;
            v13.MaxValue = 1000.0;
            v13.MinValue = 0.0;
            v13.Name = "pTQhf";
            v13.Size = 1;
            v13.Units = "Â°C d leaf-1";
            v13.URL = "";
            ...
            v14.DefaultValue = 1.5;
            v14.Description = "Factor increasing the phyllochron for leaf number higher than Lincr";
            v14.Id = 0;
            v14.MaxValue = 10.0;
            v14.MinValue = 0.0;
            v14.Name = "pincr";
            ...
            pd2.PropertyType = (SiriusQualityPhenology.DomainClass.PhenologyStateVarInfo.gAImean).ValueType.TypeForCurrentValue;
            pd2.PropertyVarInfo =(SiriusQualityPhenology.DomainClass.PhenologyStateVarInfo.gAImean);
            _inputs0_0.Add(pd2);
        ...
        public string TestPostConditions(SiriusQualityPhenology.DomainClass.PhenologyState s,SiriusQualityPhenology.DomainClass.PhenologyState s1,SiriusQualityPhenology.DomainClass.PhenologyRate r,SiriusQualityPhenology.DomainClass.PhenologyAuxiliary a,SiriusQualityPhenology.DomainClass.PhenologyExogenous ex,string callID)
        {
            try
            {
                ...
                RangeBasedCondition r19 = new RangeBasedCondition(SiriusQualityPhenology.DomainClass.PhenologyStateVarInfo.phyllochron);
                if(r19.ApplicableVarInfoValueTypes.Contains( SiriusQualityPhenology.DomainClass.PhenologyStateVarInfo.phyllochron.ValueType)){prc.AddCondition(r19);}
        ...
        public string TestPreConditions(SiriusQualityPhenology.DomainClass.PhenologyState s,SiriusQualityPhenology.DomainClass.PhenologyState s1,SiriusQualityPhenology.DomainClass.PhenologyRate r,SiriusQualityPhenology.DomainClass.PhenologyAuxiliary a,SiriusQualityPhenology.DomainClass.PhenologyExogenous ex,string callID)
        {
            try
            {
                ...
                RangeBasedCondition r2 = new RangeBasedCondition(SiriusQualityPhenology.DomainClass.PhenologyStateVarInfo.gAImean);
                if(r2.ApplicableVarInfoValueTypes.Contains( SiriusQualityPhenology.DomainClass.PhenologyStateVarInfo.gAImean.ValueType)){prc.AddCondition(r2);}
