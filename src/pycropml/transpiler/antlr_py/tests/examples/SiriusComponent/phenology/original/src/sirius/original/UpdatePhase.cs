...
namespace SiriusQualityPhenology.Strategies
{
    public class UpdatePhase : IStrategySiriusQualityPhenology
    {
        public UpdatePhase()
        {
            ...
            v1.DefaultValue = 0;
            v1.Description = "true to ignore grain maturation";
            v1.Id = 0;
            v1.MaxValue = 0;
            v1.MinValue = 0;
            v1.Name = "ignoreGrainMaturation";
            v1.Size = 1;
            v1.Units = "";
            v1.URL = "";
            ...
            v2.DefaultValue = 15;
            v2.Description = "Saturating photoperiod above which final leaf number is not influenced by daylength";
            v2.Id = 0;
            v2.MaxValue = 24;
            v2.MinValue = 0;
            v2.Name = "maxDL";
            ...
            v3.DefaultValue = 0.85;
            v3.Description = "Daylength response of leaf production";
            v3.Id = 0;
            v3.MaxValue = 1;
            v3.MinValue = 0;
            v3.Name = "sLDL";
            ...
            v4.DefaultValue = 2.22;
            v4.Description = "Phyllochronic duration of the period between flag leaf ligule appearance and anthesis";
            v4.Id = 0;
            v4.MaxValue = 1000;
            v4.MinValue = 0;
            v4.Name = "pFLLAnth";
            ...
            v6.DefaultValue = 120;
            v6.Description = "Phyllochron (Varietal parameter)";
            v6.Id = 0;
            v6.MaxValue = 1000;
            v6.MinValue = 0;
            v6.Name = "p";
            v6.Size = 1;
            v6.Units = "Â°C d leaf-1";
            v6.URL = "";
            ...
            v7.DefaultValue = 450;
            v7.Description = "Grain filling duration (from anthesis to physiological maturity)";
            v7.Id = 0;
            v7.MaxValue = 10000;
            v7.MinValue = 0;
            v7.Name = "dgf";
            ...
            v8.DefaultValue = -1D;
            v8.Description = "Switch to choose the type of phyllochron calculation to be used";
            v8.Id = 0;
            v8.MaxValue = -1D;
            v8.MinValue = -1D;
            v8.Name = "choosePhyllUse";
            v8.Size = 1;
            v8.Units = "";
            v8.URL = "";
            ...
            v9.DefaultValue = 1;
            v9.Description = "true if the plant is vernalizable";
            v9.Id = 0;
            v9.MaxValue = 1;
            v9.MinValue = 0;
            v9.Name = "isVernalizable";
            v9.Size = 1;
            v9.Units = "";
            v9.URL = "";
            ...
            v10.DefaultValue = 105;
            v10.Description = "Thermal time from sowing to emergence";
            v10.Id = 0;
            v10.MaxValue = 1000;
            v10.MinValue = 0;
            v10.Name = "dse";
            ...
            v11.DefaultValue = 1;
            v11.Description = "Number of phyllochron between heading and anthesiss";
            v11.Id = 0;
            v11.MaxValue = 1000;
            v11.MinValue = 0;
            v11.Name = "pHEADANTH";
            ...
            v12.DefaultValue = 100;
            v12.Description = "Duration of the endosperm cell division phase";
            v12.Id = 0;
            v12.MaxValue = 10000;
            v12.MinValue = 0;
            v12.Name = "dcd";
            ...
            pd2.PropertyName = "hasLastPrimordiumAppeared";
            pd2.PropertyType = (SiriusQualityPhenology.DomainClass.PhenologyStateVarInfo.hasLastPrimordiumAppeared).ValueType.TypeForCurrentValue;
            pd2.PropertyVarInfo =(SiriusQualityPhenology.DomainClass.PhenologyStateVarInfo.hasLastPrimordiumAppeared);
            _inputs0_0.Add(pd2);
            PropertyDescription pd3 = new PropertyDescription();
            pd3.DomainClassType = typeof(SiriusQualityPhenology.DomainClass.PhenologyState);
            pd3.PropertyName = "minFinalNumber";
            pd3.PropertyType = (SiriusQualityPhenology.DomainClass.PhenologyStateVarInfo.minFinalNumber).ValueType.TypeForCurrentValue;
            pd3.PropertyVarInfo =(SiriusQualityPhenology.DomainClass.PhenologyStateVarInfo.minFinalNumber);
            _inputs0_0.Add(pd3);
            PropertyDescription pd4 = new PropertyDescription();
            pd4.DomainClassType = typeof(SiriusQualityPhenology.DomainClass.PhenologyAuxiliary);
            pd4.PropertyName = "cumulTTFromZC_39";
            pd4.PropertyType = (SiriusQualityPhenology.DomainClass.PhenologyAuxiliaryVarInfo.cumulTTFromZC_39).ValueType.TypeForCurrentValue;
            pd4.PropertyVarInfo =(SiriusQualityPhenology.DomainClass.PhenologyAuxiliaryVarInfo.cumulTTFromZC_39);
            _inputs0_0.Add(pd4);
            ...
            pd7.PropertyName = "vernaprog";
            pd7.PropertyType = (SiriusQualityPhenology.DomainClass.PhenologyStateVarInfo.vernaprog).ValueType.TypeForCurrentValue;
            pd7.PropertyVarInfo =(SiriusQualityPhenology.DomainClass.PhenologyStateVarInfo.vernaprog);
            _inputs0_0.Add(pd7);
            PropertyDescription pd8 = new PropertyDescription();
            pd8.DomainClassType = typeof(SiriusQualityPhenology.DomainClass.PhenologyAuxiliary);
            pd8.PropertyName = "cumulTT";
            pd8.PropertyType = (SiriusQualityPhenology.DomainClass.PhenologyAuxiliaryVarInfo.cumulTT).ValueType.TypeForCurrentValue;
            pd8.PropertyVarInfo =(SiriusQualityPhenology.DomainClass.PhenologyAuxiliaryVarInfo.cumulTT);
            _inputs0_0.Add(pd8);
            ...
            pd10.PropertyName = "isMomentRegistredZC_39";
            pd10.PropertyType = (SiriusQualityPhenology.DomainClass.PhenologyStateVarInfo.isMomentRegistredZC_39).ValueType.TypeForCurrentValue;
            pd10.PropertyVarInfo =(SiriusQualityPhenology.DomainClass.PhenologyStateVarInfo.isMomentRegistredZC_39);
            _inputs0_0.Add(pd10);
            PropertyDescription pd11 = new PropertyDescription();
            pd11.DomainClassType = typeof(SiriusQualityPhenology.DomainClass.PhenologyState);
            pd11.PropertyName = "finalLeafNumber";
            pd11.PropertyType = (SiriusQualityPhenology.DomainClass.PhenologyStateVarInfo.finalLeafNumber).ValueType.TypeForCurrentValue;
            pd11.PropertyVarInfo =(SiriusQualityPhenology.DomainClass.PhenologyStateVarInfo.finalLeafNumber);
            _inputs0_0.Add(pd11);
            ...
            pd13.PropertyName = "phase";
            pd13.PropertyType = (SiriusQualityPhenology.DomainClass.PhenologyStateVarInfo.phase).ValueType.TypeForCurrentValue;
            pd13.PropertyVarInfo =(SiriusQualityPhenology.DomainClass.PhenologyStateVarInfo.phase);
            _inputs0_0.Add(pd13);
            PropertyDescription pd14 = new PropertyDescription();
            pd14.DomainClassType = typeof(SiriusQualityPhenology.DomainClass.PhenologyAuxiliary);
            pd14.PropertyName = "gAI";
            pd14.PropertyType = (SiriusQualityPhenology.DomainClass.PhenologyAuxiliaryVarInfo.gAI).ValueType.TypeForCurrentValue;
            pd14.PropertyVarInfo =(SiriusQualityPhenology.DomainClass.PhenologyAuxiliaryVarInfo.gAI);
            _inputs0_0.Add(pd14);
            ...
            pd16.PropertyName = "phase";
            pd16.PropertyType = (SiriusQualityPhenology.DomainClass.PhenologyStateVarInfo.phase).ValueType.TypeForCurrentValue;
            pd16.PropertyVarInfo =(SiriusQualityPhenology.DomainClass.PhenologyStateVarInfo.phase);
            ...
            pd17.PropertyName = "hasLastPrimordiumAppeared";
            pd17.PropertyType = (SiriusQualityPhenology.DomainClass.PhenologyStateVarInfo.hasLastPrimordiumAppeared).ValueType.TypeForCurrentValue;
            pd17.PropertyVarInfo =(SiriusQualityPhenology.DomainClass.PhenologyStateVarInfo.hasLastPrimordiumAppeared);
            ...
            pd18.PropertyName = "finalLeafNumber";
            pd18.PropertyType = (SiriusQualityPhenology.DomainClass.PhenologyStateVarInfo.finalLeafNumber).ValueType.TypeForCurrentValue;
            pd18.PropertyVarInfo =(SiriusQualityPhenology.DomainClass.PhenologyStateVarInfo.finalLeafNumber);
        ...
        public string TestPostConditions(SiriusQualityPhenology.DomainClass.PhenologyState s,SiriusQualityPhenology.DomainClass.PhenologyState s1,SiriusQualityPhenology.DomainClass.PhenologyRate r,SiriusQualityPhenology.DomainClass.PhenologyAuxiliary a,SiriusQualityPhenology.DomainClass.PhenologyExogenous ex,string callID)
        {
            try
            {
                ...
                RangeBasedCondition r28 = new RangeBasedCondition(SiriusQualityPhenology.DomainClass.PhenologyStateVarInfo.phase);
                if(r28.ApplicableVarInfoValueTypes.Contains( SiriusQualityPhenology.DomainClass.PhenologyStateVarInfo.phase.ValueType)){prc.AddCondition(r28);}
                RangeBasedCondition r29 = new RangeBasedCondition(SiriusQualityPhenology.DomainClass.PhenologyStateVarInfo.hasLastPrimordiumAppeared);
                if(r29.ApplicableVarInfoValueTypes.Contains( SiriusQualityPhenology.DomainClass.PhenologyStateVarInfo.hasLastPrimordiumAppeared.ValueType)){prc.AddCondition(r29);}
                RangeBasedCondition r30 = new RangeBasedCondition(SiriusQualityPhenology.DomainClass.PhenologyStateVarInfo.finalLeafNumber);
                if(r30.ApplicableVarInfoValueTypes.Contains( SiriusQualityPhenology.DomainClass.PhenologyStateVarInfo.finalLeafNumber.ValueType)){prc.AddCondition(r30);}
        ...
        public string TestPreConditions(SiriusQualityPhenology.DomainClass.PhenologyState s,SiriusQualityPhenology.DomainClass.PhenologyState s1,SiriusQualityPhenology.DomainClass.PhenologyRate r,SiriusQualityPhenology.DomainClass.PhenologyAuxiliary a,SiriusQualityPhenology.DomainClass.PhenologyExogenous ex,string callID)
        {
            try
            {
                ...
                RangeBasedCondition r2 = new RangeBasedCondition(SiriusQualityPhenology.DomainClass.PhenologyStateVarInfo.hasLastPrimordiumAppeared);
                if(r2.ApplicableVarInfoValueTypes.Contains( SiriusQualityPhenology.DomainClass.PhenologyStateVarInfo.hasLastPrimordiumAppeared.ValueType)){prc.AddCondition(r2);}
                RangeBasedCondition r3 = new RangeBasedCondition(SiriusQualityPhenology.DomainClass.PhenologyStateVarInfo.minFinalNumber);
                if(r3.ApplicableVarInfoValueTypes.Contains( SiriusQualityPhenology.DomainClass.PhenologyStateVarInfo.minFinalNumber.ValueType)){prc.AddCondition(r3);}
                RangeBasedCondition r4 = new RangeBasedCondition(SiriusQualityPhenology.DomainClass.PhenologyAuxiliaryVarInfo.cumulTTFromZC_39);
                if(r4.ApplicableVarInfoValueTypes.Contains( SiriusQualityPhenology.DomainClass.PhenologyAuxiliaryVarInfo.cumulTTFromZC_39.ValueType)){prc.AddCondition(r4);}
                RangeBasedCondition r5 = new RangeBasedCondition(SiriusQualityPhenology.DomainClass.PhenologyStateVarInfo.phyllochron);
                if(r5.ApplicableVarInfoValueTypes.Contains( SiriusQualityPhenology.DomainClass.PhenologyStateVarInfo.phyllochron.ValueType)){prc.AddCondition(r5);}
                ...
                RangeBasedCondition r7 = new RangeBasedCondition(SiriusQualityPhenology.DomainClass.PhenologyStateVarInfo.vernaprog);
                if(r7.ApplicableVarInfoValueTypes.Contains( SiriusQualityPhenology.DomainClass.PhenologyStateVarInfo.vernaprog.ValueType)){prc.AddCondition(r7);}
                RangeBasedCondition r8 = new RangeBasedCondition(SiriusQualityPhenology.DomainClass.PhenologyAuxiliaryVarInfo.cumulTT);
                if(r8.ApplicableVarInfoValueTypes.Contains( SiriusQualityPhenology.DomainClass.PhenologyAuxiliaryVarInfo.cumulTT.ValueType)){prc.AddCondition(r8);}
                ...
                RangeBasedCondition r10 = new RangeBasedCondition(SiriusQualityPhenology.DomainClass.PhenologyStateVarInfo.isMomentRegistredZC_39);
                if(r10.ApplicableVarInfoValueTypes.Contains( SiriusQualityPhenology.DomainClass.PhenologyStateVarInfo.isMomentRegistredZC_39.ValueType)){prc.AddCondition(r10);}
                RangeBasedCondition r11 = new RangeBasedCondition(SiriusQualityPhenology.DomainClass.PhenologyStateVarInfo.finalLeafNumber);
                if(r11.ApplicableVarInfoValueTypes.Contains( SiriusQualityPhenology.DomainClass.PhenologyStateVarInfo.finalLeafNumber.ValueType)){prc.AddCondition(r11);}
                ...
                RangeBasedCondition r13 = new RangeBasedCondition(SiriusQualityPhenology.DomainClass.PhenologyStateVarInfo.phase);
                if(r13.ApplicableVarInfoValueTypes.Contains( SiriusQualityPhenology.DomainClass.PhenologyStateVarInfo.phase.ValueType)){prc.AddCondition(r13);}
                RangeBasedCondition r14 = new RangeBasedCondition(SiriusQualityPhenology.DomainClass.PhenologyAuxiliaryVarInfo.gAI);
                if(r14.ApplicableVarInfoValueTypes.Contains( SiriusQualityPhenology.DomainClass.PhenologyAuxiliaryVarInfo.gAI.ValueType)){prc.AddCondition(r14);}
