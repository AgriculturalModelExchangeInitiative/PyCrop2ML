...
from pycropml.transpiler.antlr_py.java.builtin_typed_api import builtin_type_check
...
FUNCTION_API = {
    ...
    'Math': {
        ...
        'log10':    StandardCall('math', 'log', expander=log10_expander),
...
PROPERTY_API = {
    ...
    "array":{
        "length": StandardMethodCall("array", "len",default={1: [{'type': 'str', 'value': ' ', 'pseudo_type': 'str'}]}, expander=len_expander)
    }
}
